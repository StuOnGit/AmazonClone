...
struct BestSellerWomenView: View {
    ...
    var body: some View {
        VStack{
            HStack{
                Text("Best seller for women from our brands")
                    .font(.title2)
                    .bold()
                Spacer()
            }
...
struct BestSellerWomenView_Previews: PreviewProvider {
    static var previews: some View {
        BestSellerWomenView(items: AmazonItemsDBAmazon)
    }
}
